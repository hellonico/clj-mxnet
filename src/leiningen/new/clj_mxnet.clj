(ns leiningen.new.clj-mxnet
  (:use [leiningen.new.templates :only [raw-resourcer renderer name-to-path sanitize-ns ->files]]))

(def render (renderer "clj-mxnet"))
(def raw (raw-resourcer "clj-mxnet"))
...
; samples
["src/tutorial/introduction.clj" (render "src/tutorial/introduction.clj" data)]
